...
// Using https://www.npmjs.com/package/@gnus.ai/contracts-upgradeable-diamond over traditional openzeppelin contracts
// to work with diamond standard
...
contract SentinelFacet is ISentinelFacet, AccessControlEnumerableUpgradeable {
    ...
    function initialize(address root) public virtual override initializer {
    ...
    function isGuardian(address account) public view virtual override returns (bool) {
